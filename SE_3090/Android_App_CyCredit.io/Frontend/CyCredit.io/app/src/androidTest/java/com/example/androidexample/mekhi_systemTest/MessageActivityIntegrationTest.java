...
import cycredit.io.chat.MessageActivity;
import cycredit.io.R;
import cycredit.io.Session;

/**
 * Integration tests for Message Activity (Public Chat)
 * Tests: Chat display, message sending, refresh
 */
@RunWith(AndroidJUnit4.class)
public class MessageActivityIntegrationTest {

    private static final int TEST_USER_ID = 1;
    private static final String TEST_EMAIL = "test@example.com";

    @Rule
    public ActivityScenarioRule<MessageActivity> activityRule =
    ...
    @Test
    public void testMessagesRecyclerViewExists() {
    ...
    public void testMessageInputExists() {
        ...
        Espresso.onView(ViewMatchers.withId(R.id.etMessage))
                .check(existsAssertion);
    }
