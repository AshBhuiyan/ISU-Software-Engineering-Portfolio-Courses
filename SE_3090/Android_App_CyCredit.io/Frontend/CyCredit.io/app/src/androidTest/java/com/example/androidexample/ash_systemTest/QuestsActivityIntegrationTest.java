...
import cycredit.io.QuestsActivity;
import cycredit.io.R;
import cycredit.io.Session;

/**
 * Integration tests for Quests Activity
 * Tests: Quest display, progress tracking, completion status
 */
@RunWith(AndroidJUnit4.class)
public class QuestsActivityIntegrationTest {

    private static final int TEST_USER_ID = 1;
    private static final String TEST_EMAIL = "test@example.com";

    @Rule
    public ActivityScenarioRule<QuestsActivity> activityRule =
    ...
    @Test
    public void testQuestsRecyclerViewExists() {
        ViewAssertion existsAssertion = (view, noViewFoundException) -> {
            if (noViewFoundException != null) {
                throw noViewFoundException;
            }
        };
        Espresso.onView(ViewMatchers.withId(R.id.recycler_quests))
    ...
    public void testBackButtonExists() {
        ...
        Espresso.onView(ViewMatchers.withId(R.id.btn_back_quests))
                .check(existsAssertion);
    }
}
